...
namespace main_savitch_10
{
	...
	{ 
		...
		tags_field = init_tags;
	    Ltags_field = init_Ltags;
	    Rtags_field = init_Rtags;
	}
	...
	int *&Ltags( ) {return Ltags; }
	int *&Rtags( ) {return Rtags; }
	void set_data(const Item& new_data) { data_field = new_data; }
	void set_left(binary_tree_node *new_left) { left_field = new_left; }
	void set_right(binary_tree_node *new_right) { right_field = new_right; }
	void set_tags(binary_tree_node *currentPtr);			//tags not yet fully implemented 
	void set_Ltags(binary_tree_node *currentPtr);
	void set_Rtags(binary_tree_node *currentPtr);
	void combine_tags(binary_tree_node *currentPtr);
